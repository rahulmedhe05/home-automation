...
const keyword = getKeywordBySlug("home-automation", "ac-automation-vadodara")!;
const uniqueContent = getKeywordContent("ac-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `AC Automation Vadodara, Smart AC Control, Air Conditioner Automation`,
  openGraph: {
    title: keyword.title,
...
export default function ACAutomationVadodaraPage() {
