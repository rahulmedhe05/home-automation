...
const keyword = getKeywordBySlug("home-automation", "alexa-home-automation-vadodara")!;
const uniqueContent = getKeywordContent("alexa-home-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Alexa Home Automation, Amazon Echo Setup, Voice Control Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function AlexaHomeAutomationVadodaraPage() {
