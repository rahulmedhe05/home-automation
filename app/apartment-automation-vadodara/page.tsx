...
const keyword = getKeywordBySlug("home-automation", "apartment-automation-vadodara")!;
const uniqueContent = getKeywordContent("apartment-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Apartment Automation, Flat Smart Home, 1BHK 2BHK 3BHK Automation`,
  openGraph: {
    title: keyword.title,
...
export default function ApartmentAutomationVadodaraPage() {
