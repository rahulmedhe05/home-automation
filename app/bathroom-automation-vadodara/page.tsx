...
const keyword = getKeywordBySlug("home-automation", "bathroom-automation-vadodara")!;
const uniqueContent = getKeywordContent("bathroom-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Bathroom Automation, Smart Bathroom, Geyser Control Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function BathroomAutomationVadodaraPage() {
