...
const keyword = getKeywordBySlug("home-automation", "bedroom-automation-vadodara")!;
const uniqueContent = getKeywordContent("bedroom-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Bedroom Automation, Smart Bedroom, Sleep Automation Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function BedroomAutomationVadodaraPage() {
