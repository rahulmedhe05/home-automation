...
const keyword = getKeywordBySlug("home-automation", "budget-smart-home-vadodara")!;
const uniqueContent = getKeywordContent("budget-smart-home-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Budget Smart Home, Affordable Automation, Under 20K Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function BudgetSmartHomeVadodaraPage() {
