...
const keyword = getKeywordBySlug("home-automation", "bungalow-automation-vadodara")!;
const uniqueContent = getKeywordContent("bungalow-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Bungalow Automation, Villa Smart Home, Luxury Home Automation`,
  openGraph: {
    title: keyword.title,
...
export default function BungalowAutomationVadodaraPage() {
