...
const keyword = getKeywordBySlug("home-automation", "child-safety-automation-vadodara")!;
const uniqueContent = getKeywordContent("child-safety-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Child Safety Automation, Kids Safe Home, Parental Control Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function ChildSafetyAutomationVadodaraPage() {
