...
const keyword = getKeywordBySlug("home-automation", "curtain-automation-vadodara")!;
const uniqueContent = getKeywordContent("curtain-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Curtain Automation, Motorized Blinds, Smart Curtains Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function CurtainAutomationVadodaraPage() {
