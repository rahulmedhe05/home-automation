...
const keyword = getKeywordBySlug("home-automation", "elderly-home-automation-vadodara")!;
const uniqueContent = getKeywordContent("elderly-home-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Elderly Home Automation, Senior Friendly, Easy Control Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function ElderlyHomeAutomationVadodaraPage() {
