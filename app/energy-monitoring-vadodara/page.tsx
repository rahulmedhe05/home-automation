...
const keyword = getKeywordBySlug("home-automation", "energy-monitoring-vadodara")!;
const uniqueContent = getKeywordContent("energy-monitoring-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Energy Monitoring, Smart Meter, Electricity Tracker Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function EnergyMonitoringVadodaraPage() {
