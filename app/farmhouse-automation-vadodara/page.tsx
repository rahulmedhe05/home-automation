...
const keyword = getKeywordBySlug("home-automation", "farmhouse-automation-vadodara")!;
const uniqueContent = getKeywordContent("farmhouse-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Farmhouse Automation, Weekend Home, Remote Monitoring Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function FarmhouseAutomationVadodaraPage() {
