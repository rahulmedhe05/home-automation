...
const keyword = getKeywordBySlug("home-automation", "garden-automation-vadodara")!;
const uniqueContent = getKeywordContent("garden-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Garden Automation, Smart Irrigation, Lawn Sprinkler Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function GardenAutomationVadodaraPage() {
