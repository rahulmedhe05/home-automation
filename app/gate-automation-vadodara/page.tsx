...
const keyword = getKeywordBySlug("home-automation", "gate-automation-vadodara")!;
const uniqueContent = getKeywordContent("gate-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Gate Automation, Automatic Gate, Sliding Gate Motor Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function GateAutomationVadodaraPage() {
