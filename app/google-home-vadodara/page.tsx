...
const keyword = getKeywordBySlug("home-automation", "google-home-vadodara")!;
const uniqueContent = getKeywordContent("google-home-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Google Home Vadodara, Hey Google, Google Assistant Home Control`,
  openGraph: {
    title: keyword.title,
...
export default function GoogleHomeVadodaraPage() {
