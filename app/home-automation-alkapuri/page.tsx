...
const keyword = getKeywordBySlug("home-automation", "home-automation-alkapuri")!;
const uniqueContent = getKeywordContent("home-automation-alkapuri");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Home Automation Alkapuri, Premium Smart Home, Luxury Automation Alkapuri`,
  openGraph: {
    title: keyword.title,
...
export default function HomeAutomationAlkapuriPage() {
