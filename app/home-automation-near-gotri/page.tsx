...
const keyword = getKeywordBySlug("home-automation", "home-automation-near-gotri")!;
const uniqueContent = getKeywordContent("home-automation-near-gotri");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Home Automation Gotri, Smart Home Near Gotri, Local Service Gotri`,
  openGraph: {
    title: keyword.title,
...
export default function HomeAutomationNearGotriPage() {
