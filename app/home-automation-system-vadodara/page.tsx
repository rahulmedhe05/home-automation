...
const keyword = getKeywordBySlug("home-automation", "home-automation-system-vadodara")!;
const uniqueContent = getKeywordContent("home-automation-system-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Home Automation System, Wired Wireless Automation, Smart Home System Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function HomeAutomationSystemVadodaraPage() {
