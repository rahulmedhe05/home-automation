...
const keyword = getKeywordBySlug("home-automation", "home-automation-training-vadodara")!;
const uniqueContent = getKeywordContent("home-automation-training-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Home Automation Training, User Training, How to Use Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function HomeAutomationTrainingVadodaraPage() {
