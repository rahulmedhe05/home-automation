...
const keyword = getKeywordBySlug("home-automation", "home-automation-vadodara")!;
const uniqueContent = getKeywordContent("home-automation-vadodara");
...
export default function HomeAutomationVadodaraPage() {
