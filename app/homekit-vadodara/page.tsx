...
const keyword = getKeywordBySlug("home-automation", "homekit-vadodara")!;
const uniqueContent = getKeywordContent("homekit-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Apple HomeKit, iPhone Home Control, Siri Automation Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function HomekitVadodaraPage() {
