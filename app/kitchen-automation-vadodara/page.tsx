...
const keyword = getKeywordBySlug("home-automation", "kitchen-automation-vadodara")!;
const uniqueContent = getKeywordContent("kitchen-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Kitchen Automation, Smart Kitchen, Appliance Control Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function KitchenAutomationVadodaraPage() {
