...
const keyword = getKeywordBySlug("home-automation", "living-room-automation-vadodara")!;
const uniqueContent = getKeywordContent("living-room-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Living Room Automation, Smart Living Room, Entertainment Automation`,
  openGraph: {
    title: keyword.title,
...
export default function LivingRoomAutomationVadodaraPage() {
