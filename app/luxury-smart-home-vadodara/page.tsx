...
const keyword = getKeywordBySlug("home-automation", "luxury-smart-home-vadodara")!;
const uniqueContent = getKeywordContent("luxury-smart-home-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Luxury Smart Home, Premium Automation, High End Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function LuxurySmartHomeVadodaraPage() {
