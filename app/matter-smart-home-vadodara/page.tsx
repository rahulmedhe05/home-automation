...
const keyword = getKeywordBySlug("home-automation", "matter-smart-home-vadodara")!;
const uniqueContent = getKeywordContent("matter-smart-home-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Matter Smart Home, Matter Protocol, Universal Devices Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function MatterSmartHomeVadodaraPage() {
