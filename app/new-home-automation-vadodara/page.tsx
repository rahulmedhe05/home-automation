...
const keyword = getKeywordBySlug("home-automation", "new-home-automation-vadodara")!;
const uniqueContent = getKeywordContent("new-home-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `New Home Automation, Under Construction, Pre-Wiring Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function NewHomeAutomationVadodaraPage() {
