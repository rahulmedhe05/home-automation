...
const keyword = getKeywordBySlug("home-automation", "office-automation-vadodara")!;
const uniqueContent = getKeywordContent("office-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Office Automation, Smart Office, Commercial Automation Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function OfficeAutomationVadodaraPage() {
