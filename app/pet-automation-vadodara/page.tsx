...
const keyword = getKeywordBySlug("home-automation", "pet-automation-vadodara")!;
const uniqueContent = getKeywordContent("pet-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Pet Automation, Pet Camera, Smart Pet Feeder Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function PetAutomationVadodaraPage() {
