...
const keyword = getKeywordBySlug("home-automation", "pool-automation-vadodara")!;
const uniqueContent = getKeywordContent("pool-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Pool Automation, Swimming Pool Control, Smart Pool Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function PoolAutomationVadodaraPage() {
