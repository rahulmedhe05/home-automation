...
const keyword = getKeywordBySlug("home-automation", "rental-home-automation-vadodara")!;
const uniqueContent = getKeywordContent("rental-home-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Rental Home Automation, Tenant Friendly, Portable Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function RentalHomeAutomationVadodaraPage() {
