...
const keyword = getKeywordBySlug("home-automation", "showroom-automation-vadodara")!;
const uniqueContent = getKeywordContent("showroom-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Showroom Automation, Retail Automation, Shop Smart Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function ShowroomAutomationVadodaraPage() {
