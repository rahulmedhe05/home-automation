...
const keyword = getKeywordBySlug("home-automation", "smart-alarm-system-vadodara")!;
const uniqueContent = getKeywordContent("smart-alarm-system-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Alarm System, Burglar Alarm, Intrusion Detection Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SmartAlarmSystemVadodaraPage() {
