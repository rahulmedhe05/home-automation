...
const keyword = getKeywordBySlug("home-automation", "smart-camera-vadodara")!;
const uniqueContent = getKeywordContent("smart-camera-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Camera Vadodara, WiFi CCTV, IP Camera, Security Camera`,
  openGraph: {
    title: keyword.title,
...
export default function SmartCameraVadodaraPage() {
