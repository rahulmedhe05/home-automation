...
const keyword = getKeywordBySlug("home-automation", "smart-doorbell-vadodara")!;
const uniqueContent = getKeywordContent("smart-doorbell-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Doorbell Vadodara, Video Doorbell, Ring Doorbell, WiFi Doorbell`,
  openGraph: {
    title: keyword.title,
...
export default function SmartDoorbellVadodaraPage() {
