...
const keyword = getKeywordBySlug("home-automation", "smart-fan-vadodara")!;
const uniqueContent = getKeywordContent("smart-fan-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Fan Vadodara, WiFi Ceiling Fan, Voice Control Fan, BLDC Fan`,
  openGraph: {
    title: keyword.title,
...
export default function SmartFanVadodaraPage() {
