...
const keyword = getKeywordBySlug("home-automation", "smart-geyser-vadodara")!;
const uniqueContent = getKeywordContent("smart-geyser-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Geyser Vadodara, WiFi Water Heater, Timer Geyser, Automated Geyser`,
  openGraph: {
    title: keyword.title,
...
export default function SmartGeyserVadodaraPage() {
