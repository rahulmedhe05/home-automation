...
const keyword = getKeywordBySlug("home-automation", "smart-home-automation-vadodara")!;
const uniqueContent = getKeywordContent("smart-home-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Home Automation Vadodara, Complete Smart Home, Voice Control Home`,
  openGraph: {
    title: keyword.title,
...
export default function SmartHomeAutomationVadodaraPage() {
