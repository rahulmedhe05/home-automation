...
const keyword = getKeywordBySlug("home-automation", "smart-home-company-vadodara")!;
const uniqueContent = getKeywordContent("smart-home-company-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Home Company Vadodara, Best Smart Home Provider, Trusted Automation Company`,
  openGraph: {
    title: keyword.title,
...
export default function SmartHomeCompanyVadodaraPage() {
