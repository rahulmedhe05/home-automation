...
const keyword = getKeywordBySlug("home-automation", "smart-home-consultation-vadodara")!;
const uniqueContent = getKeywordContent("smart-home-consultation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Home Consultation, Free Home Visit, Expert Advice Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SmartHomeConsultationVadodaraPage() {
