...
const keyword = getKeywordBySlug("home-automation", "smart-home-dealers-vadodara")!;
const uniqueContent = getKeywordContent("smart-home-dealers-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Home Dealers, Authorized Dealer, Smart Products Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SmartHomeDealersVadodaraPage() {
