...
const keyword = getKeywordBySlug("home-automation", "smart-home-emi-vadodara")!;
const uniqueContent = getKeywordContent("smart-home-emi-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Home EMI, Finance Options, Easy Payment Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SmartHomeEMIVadodaraPage() {
