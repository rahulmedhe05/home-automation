...
const keyword = getKeywordBySlug("home-automation", "smart-home-maintenance-vadodara")!;
const uniqueContent = getKeywordContent("smart-home-maintenance-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Home Maintenance, AMC, Service Support Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SmartHomeMaintenanceVadodaraPage() {
