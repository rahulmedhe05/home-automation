...
const keyword = getKeywordBySlug("home-automation", "smart-home-repair-vadodara")!;
const uniqueContent = getKeywordContent("smart-home-repair-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Home Repair, Device Repair, Troubleshooting Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SmartHomeRepairVadodaraPage() {
