...
const keyword = getKeywordBySlug("home-automation", "smart-home-retrofit-vadodara")!;
const uniqueContent = getKeywordContent("smart-home-retrofit-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Home Retrofit, Upgrade Existing Home, No Rewiring Smart Home`,
  openGraph: {
    title: keyword.title,
...
export default function SmartHomeRetrofitVadodaraPage() {
