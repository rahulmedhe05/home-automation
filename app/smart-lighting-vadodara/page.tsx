...
const keyword = getKeywordBySlug("home-automation", "smart-lighting-vadodara")!;
const uniqueContent = getKeywordContent("smart-lighting-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Lighting Vadodara, Automated Lights, LED Smart Bulbs, Dimmer Control`,
  openGraph: {
    title: keyword.title,
...
export default function SmartLightingVadodaraPage() {
