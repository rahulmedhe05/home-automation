...
const keyword = getKeywordBySlug("home-automation", "smart-plug-vadodara")!;
const uniqueContent = getKeywordContent("smart-plug-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Plug, WiFi Plug, Timer Switch, Voice Control Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SmartPlugVadodaraPage() {
