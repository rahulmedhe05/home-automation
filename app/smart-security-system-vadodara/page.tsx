...
const keyword = getKeywordBySlug("home-automation", "smart-security-system-vadodara")!;
const uniqueContent = getKeywordContent("smart-security-system-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Security System, CCTV Cameras, Smart Locks, Home Security Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SmartSecuritySystemVadodaraPage() {
