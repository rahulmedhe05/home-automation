...
const keyword = getKeywordBySlug("home-automation", "smart-speaker-vadodara")!;
const uniqueContent = getKeywordContent("smart-speaker-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Speaker Vadodara, Alexa Echo, Google Nest, Apple HomePod`,
  openGraph: {
    title: keyword.title,
...
export default function SmartSpeakerVadodaraPage() {
