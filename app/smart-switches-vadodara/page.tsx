...
const keyword = getKeywordBySlug("home-automation", "smart-switches-vadodara")!;
const uniqueContent = getKeywordContent("smart-switches-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Switches Vadodara, Touch Switches, WiFi Switches, Smart Switch Price`,
  openGraph: {
    title: keyword.title,
...
export default function SmartSwitchesVadodaraPage() {
