...
const keyword = getKeywordBySlug("home-automation", "smart-thermostat-vadodara")!;
const uniqueContent = getKeywordContent("smart-thermostat-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart Thermostat Vadodara, WiFi AC Control, Temperature Control`,
  openGraph: {
    title: keyword.title,
...
export default function SmartThermostatVadodaraPage() {
