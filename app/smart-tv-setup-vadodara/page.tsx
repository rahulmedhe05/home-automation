...
const keyword = getKeywordBySlug("home-automation", "smart-tv-setup-vadodara")!;
const uniqueContent = getKeywordContent("smart-tv-setup-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smart TV Setup Vadodara, Home Theatre, Entertainment System`,
  openGraph: {
    title: keyword.title,
...
export default function SmartTVSetupVadodaraPage() {
