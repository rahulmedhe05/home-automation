...
const keyword = getKeywordBySlug("home-automation", "smartthings-vadodara")!;
const uniqueContent = getKeywordContent("smartthings-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Samsung SmartThings, SmartThings Hub, Setup Service Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SmartthingsVadodaraPage() {
