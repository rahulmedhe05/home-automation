...
const keyword = getKeywordBySlug("home-automation", "smoke-detector-vadodara")!;
const uniqueContent = getKeywordContent("smoke-detector-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Smoke Detector, Fire Alarm, Smart Fire Safety Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SmokeDetectorVadodaraPage() {
