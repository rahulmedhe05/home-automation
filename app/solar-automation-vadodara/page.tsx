...
const keyword = getKeywordBySlug("home-automation", "solar-automation-vadodara")!;
const uniqueContent = getKeywordContent("solar-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Solar Automation, Smart Solar, Inverter Monitoring Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SolarAutomationVadodaraPage() {
