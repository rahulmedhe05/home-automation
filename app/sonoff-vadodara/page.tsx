...
const keyword = getKeywordBySlug("home-automation", "sonoff-vadodara")!;
const uniqueContent = getKeywordContent("sonoff-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Sonoff, Sonoff Switches, WiFi Relay Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function SonoffVadodaraPage() {
