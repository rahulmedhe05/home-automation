...
const keyword = getKeywordBySlug("home-automation", "tuya-smart-vadodara")!;
const uniqueContent = getKeywordContent("tuya-smart-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Tuya Smart Home, Smart Life App, Budget Automation Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function TuyaSmartVadodaraPage() {
