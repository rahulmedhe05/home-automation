...
const keyword = getKeywordBySlug("home-automation", "vacation-mode-automation-vadodara")!;
const uniqueContent = getKeywordContent("vacation-mode-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Vacation Mode, Away Mode, Home Security Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function VacationModeAutomationVadodaraPage() {
