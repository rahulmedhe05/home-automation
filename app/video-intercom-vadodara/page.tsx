...
const keyword = getKeywordBySlug("home-automation", "video-intercom-vadodara")!;
const uniqueContent = getKeywordContent("video-intercom-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Video Intercom, Door Phone, Visitor Management Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function VideoIntercomVadodaraPage() {
