...
const keyword = getKeywordBySlug("home-automation", "water-leak-detector-vadodara")!;
const uniqueContent = getKeywordContent("water-leak-detector-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Water Leak Detector, Flood Sensor, Leak Alert Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function WaterLeakDetectorVadodaraPage() {
