...
const keyword = getKeywordBySlug("home-automation", "wifi-home-automation-vadodara")!;
const uniqueContent = getKeywordContent("wifi-home-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `WiFi Home Automation, Internet Connected Home, Smart App Control`,
  openGraph: {
    title: keyword.title,
...
export default function WifiHomeAutomationVadodaraPage() {
