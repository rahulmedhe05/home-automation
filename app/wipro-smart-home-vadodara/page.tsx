...
const keyword = getKeywordBySlug("home-automation", "wipro-smart-home-vadodara")!;
const uniqueContent = getKeywordContent("wipro-smart-home-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Wipro Smart Home, Wipro Lights, Indian Brand Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function WiproSmartHomeVadodaraPage() {
