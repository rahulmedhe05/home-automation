...
const keyword = getKeywordBySlug("home-automation", "wired-vs-wireless-automation-vadodara")!;
const uniqueContent = getKeywordContent("wired-vs-wireless-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Wired vs Wireless, Automation Comparison, Guide Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function WiredVsWirelessAutomationVadodaraPage() {
