...
const keyword = getKeywordBySlug("home-automation", "wireless-home-automation-vadodara")!;
const uniqueContent = getKeywordContent("wireless-home-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Wireless Home Automation, No Wiring Needed, Quick Install Smart Home`,
  openGraph: {
    title: keyword.title,
...
export default function WirelessHomeAutomationVadodaraPage() {
