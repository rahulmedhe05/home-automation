...
const keyword = getKeywordBySlug("home-automation", "work-from-home-automation-vadodara")!;
const uniqueContent = getKeywordContent("work-from-home-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Work From Home Automation, Home Office, Productivity Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function WorkFromHomeAutomationVadodaraPage() {
