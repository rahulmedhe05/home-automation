...
const keyword = getKeywordBySlug("home-automation", "zigbee-automation-vadodara")!;
const uniqueContent = getKeywordContent("zigbee-automation-vadodara");

export const metadata: Metadata = {
  title: uniqueContent?.heroTitle || keyword.title,
  description: uniqueContent?.heroSubtitle || keyword.metaDescription,
  keywords: `Zigbee Automation, Zigbee Devices, Smart Hub Vadodara`,
  openGraph: {
    title: keyword.title,
...
export default function ZigbeeAutomationVadodaraPage() {
