...
export function BusinessPageTemplate({ business, area, content, areaContent }: BusinessPageTemplateProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
          ...
          <div className="max-w-3xl text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-pink-600 to-pink-800 text-white px-8 py-4 rounded-full font-bold text-lg hover:from-pink-700 hover:to-pink-900 transition-all shadow-lg"
              >
                <Phone className="w-5 h-5" />
                Call: +91 84889 13458
              </a>
              <a
                href={`https://wa.me/918488913458?text=Hi, I'm interested in home automation in ${areaName}`}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {stats.map((stat, index) => (
              <div key={index} className="flex flex-col items-center">
                <p className="text-3xl md:text-4xl font-bold" style={{color: 'var(--color-primary, #E91E8C)'}}>{stat.value}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {content.detailedServices.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow border-l-4 border-primary"
                >
                  <div className="flex items-center gap-3 mb-4">
      ...
      <section id="products" className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 max-w-7xl mx-auto">
            {[
              { name: "WiFi & Zigbee Touch Panel", img: "https://bizimages.withfloats.com/actual/fa610dc1926447f2a3e4c9e341c6e763.jpg", href: "https://www.varnidigital.in/wifi-zigbee-touch-panel/183" },
              { name: "Glass Touch Panel", img: "https://bizimages.withfloats.com/actual/a9f1d28f8afc4f77863c65183e0bfcdd.jpg", href: "https://www.varnidigital.in/glass-touch-panel/182" },
              { name: "Touch 4 Switch 1 Socket", img: "https://bizimages.withfloats.com/actual/d6278900544641649ce6f68fa0525c3d.jpg", href: "https://www.varnidigital.in/touch-4-switch-1-socket/181" },
              { name: "Touch 10 Switch 1 Fan", img: "https://productimages.withfloats.com/serviceimages/actual/641ae3a3472ae5787103de55Touch10Switch1Fan2Socket", href: "https://www.varnidigital.in/touch-10-switch-1-fan-2-socket/180" },
              { name: "Capacitive Touch Switch", img: "https://bizimages.withfloats.com/actual/fa610dc1926447f2a3e4c9e341c6e763.jpg", href: "https://www.varnidigital.in/category/capacitive-touch-switch/1" },
              { name: "Smart Touch Switch", img: "https://bizimages.withfloats.com/actual/a9f1d28f8afc4f77863c65183e0bfcdd.jpg", href: "https://www.varnidigital.in/category/smart-touch-switch/1" },
              { name: "Modular Touch Switch", img: "https://bizimages.withfloats.com/actual/d6278900544641649ce6f68fa0525c3d.jpg", href: "https://www.varnidigital.in/category/modular-touch-switch/1" },
              { name: "Edge Touch Switch", img: "https://bizimages.withfloats.com/actual/fa610dc1926447f2a3e4c9e341c6e763.jpg", href: "https://www.varnidigital.in/category/edge-touch-switch/1" },
              { name: "Touch Switch With Socket", img: "https://bizimages.withfloats.com/actual/a9f1d28f8afc4f77863c65183e0bfcdd.jpg", href: "https://www.varnidigital.in/category/touch-switch-with-socket/1" },
              { name: "Hotel Automation", img: "https://bizimages.withfloats.com/actual/d6278900544641649ce6f68fa0525c3d.jpg", href: "https://www.varnidigital.in/category/hotel-automation/1" },
            ].map((product, i) => (
              <a
                key={i}
                href={product.href}
          ...
          <div className="text-center mt-10">
            <a
              href="https://www.varnidigital.in/all/Products/1"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-primary text-white px-8 py-3 rounded-full font-bold hover:opacity-90 transition-all shadow-lg"
            >
              View All Products →
            </a>
          </div>
      ...
      {/* Why Choose Us */}
      <section className="py-16 md:py-20 bg-gradient-to-br from-black to-gray-900 text-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto">
            <div>
            ...
            {content.packages.map((pkg, index) => (
              <div
                ...
                className={`relative p-6 rounded-2xl ${
                  pkg.popular ? "bg-primary text-white scale-105 shadow-xl" : "bg-white shadow-lg border border-gray-100"
                }`}
              >
                {pkg.popular && (
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+916353583148"
              className="inline-flex items-center justify-center gap-2 bg-white text-black px-8 py-4 rounded-full font-bold hover:bg-gray-100 transition-all"
            >
              <Phone className="w-5 h-5" />
              Call: +91 84889 13458
            </a>
            <a
              href={`https://wa.me/918488913458?text=Hi, I need home automation services in ${areaName}`}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <a href="tel:+918488913458" className="flex flex-col items-center p-6 bg-white/10 rounded-xl hover:bg-white/20 transition-colors">
                <Phone className="w-8 h-8 mb-3" />
                <p className="font-bold">Call Us</p>
                <p className="opacity-90">+91 84889 13458</p>
              </a>
              <a href="mailto:varnidigital@gmail.com" className="flex flex-col items-center p-6 bg-white/10 rounded-xl hover:bg-white/20 transition-colors">
