      ...
      <div className="container mx-auto px-3 sm:px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            <p className="text-accent font-mono uppercase tracking-wider mb-2 md:mb-4 text-xs sm:text-sm">Get Your Smart Home Consultation</p>
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 md:mb-6 text-balance">Transform Your Space With Smart Automation</h2>
            <p className="text-sm sm:text-base md:text-xl text-primary-foreground/90 font-mono leading-relaxed max-w-2xl mx-auto">
              {"Our smart home team will help you choose touch switches, app control, voice control, lighting, curtains, AC automation and security solutions."}
            </p>
          </div>
              ...
              <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-8 border border-primary-foreground/20">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-primary-foreground/80 font-mono mb-2">Mon-Sat: 9 AM - 6 PM</p>
                    <a
